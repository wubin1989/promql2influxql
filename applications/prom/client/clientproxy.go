...
func WithRunner(runner goresilience.Runner) ProxyOption {
	return func(proxy *PromClientProxy) {
		proxy.runner = runner
	}
}
...
func NewPromClientProxy(client *PromClient, opts ...ProxyOption) *PromClientProxy {
	...
	if cp.runner == nil {
		...
		mid = append(mid, metrics.NewMiddleware("github.com/wubin1989/promql2influxql/applications/prom_client", metrics.NewPrometheusRecorder(prometheus.DefaultRegisterer)))
