...
func (receiver *RpcHandlerImpl) Query(_writer http.ResponseWriter, _req *http.Request) {
	var (
		ctx     context.Context
		query   string
		time    *string
	...
	data, status, err = receiver.rpc.Query(
		ctx,
		query,
		time,
		timeout,
...
func (receiver *RpcHandlerImpl) GetQuery(_writer http.ResponseWriter, _req *http.Request) {
	var (
		ctx     context.Context
		query   string
		time    *string
	...
	data, status, err = receiver.rpc.GetQuery(
		ctx,
		query,
		time,
		timeout,
...
func (receiver *RpcHandlerImpl) Query_range(_writer http.ResponseWriter, _req *http.Request) {
	var (
		ctx     context.Context
		query   string
		start   *string
	...
	data, status, err = receiver.rpc.Query_range(
		ctx,
		query,
		start,
		end,
...
func (receiver *RpcHandlerImpl) GetQuery_range(_writer http.ResponseWriter, _req *http.Request) {
	var (
		ctx     context.Context
		query   string
		start   *string
	...
	data, status, err = receiver.rpc.GetQuery_range(
		ctx,
		query,
		start,
		end,
...
func NewRpcHandler(rpc service.Rpc) RpcHandler {
