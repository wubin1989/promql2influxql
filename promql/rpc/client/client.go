...
func (receiver *RpcClient) SetRootPath(rootPath string) {
	receiver.rootPath = rootPath
}

func (receiver *RpcClient) SetProvider(provider registry.IServiceProvider) {
	receiver.provider = provider
}

func (receiver *RpcClient) SetClient(client *resty.Client) {
	receiver.client = client
}
func (receiver *RpcClient) Query(ctx context.Context, _headers map[string]string, query string, time *string, timeout *string) (_resp *resty.Response, data dto.QueryData, status string, err error) {
	var _err error
...
func (receiver *RpcClient) GetQuery(ctx context.Context, _headers map[string]string, query string, time *string, timeout *string) (_resp *resty.Response, data dto.QueryData, status string, err error) {
	var _err error
	_urlValues := url.Values{}
	_req := receiver.client.R()
	if len(_headers) > 0 {
...
func (receiver *RpcClient) Query_range(ctx context.Context, _headers map[string]string, query string, start *string, end *string, step *string, timeout *string) (_resp *resty.Response, data dto.QueryData, status string, err error) {
	var _err error
	_urlValues := url.Values{}
	_req := receiver.client.R()
	if len(_headers) > 0 {
...
func (receiver *RpcClient) GetQuery_range(ctx context.Context, _headers map[string]string, query string, start *string, end *string, step *string, timeout *string) (_resp *resty.Response, data dto.QueryData, status string, err error) {
	var _err error
	_urlValues := url.Values{}
	_req := receiver.client.R()
	if len(_headers) > 0 {
