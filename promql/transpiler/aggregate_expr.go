...
var aggregateFns = map[parser.ItemType]aggregateFn{
	parser.ItemSum:      {name: "sum", dropField: true, dropNonGrouping: false},
	parser.ItemAvg:      {name: "mean", dropField: true, dropNonGrouping: false},
	parser.ItemMax:      {name: "max", dropField: true, dropNonGrouping: true},
	parser.ItemMin:      {name: "min", dropField: true, dropNonGrouping: true},
	parser.ItemCount:    {name: "count", dropField: true, dropNonGrouping: false},
	parser.ItemStddev:   {name: "stddev", dropField: true, dropNonGrouping: false},
	parser.ItemStdvar:   {name: "stddev", dropField: true, dropNonGrouping: false},
	parser.ItemTopK:     {name: "top", dropField: false, dropNonGrouping: false},
	parser.ItemBottomK:  {name: "bottom", dropField: false, dropNonGrouping: false},
	parser.ItemQuantile: {name: "quantile", dropField: true, dropNonGrouping: false},
}
...
func (t *Transpiler) transpileAggregateExpr(a *parser.AggregateExpr) (ast.Expression, error) {
	...
	switch a.Op {
	case parser.ItemTopK, parser.ItemBottomK:
	...
	case parser.ItemStddev, parser.ItemStdvar:
